...
namespace Code.Fractal
{
    ...
    public class Fractal : MonoBehaviour
    {
        ...
        [SerializeField, Range(0, 1)] private float _speedRotation = 0.125f;
        ...
        private void OnEnable()
        {
            ...
            {
                _parts[i] = new NativeArray<FractalPart>();
                _matrices[i] = new NativeArray<Matrix4x4>();
        ...
        public struct UpdateFractalLevelJob: IJobFor
        {
            ...
            public void Execute(int index)
            {
                ...
                part.WorldPosition =
                    ...
                    mul(parent.WorldPosition, _positionOffset * Scale * part.Direction);
